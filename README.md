...
## About Me
I build software applications and cloud-based solutions with a focus on cloud infrastructure, deployment, automation, and backend development.

I enjoy taking applications from development to deployment using cloud platforms, CI/CD pipelines, databases, APIs, and Linux environments.
...
Migrated a local SQL Server database to Azure SQL Database and successfully connected it to applications and SQL Server Management Studio.
...
Labs demonstrating my ability to handle data by creating, manipulating, filtering, and querying relational databases.
...
## More About My Work
I continuously explore cloud deployments, CI/CD pipelines, serverless applications, scalable backend systems, and cloud infrastructure while improving my DevOps, development, Linux, and cloud engineering skills.
